...
Output: outputs/midea_backtest_dashboard.html
"""
import sys
import io
import os
...
CSV_PATH = os.path.join(ROOT, "data", "midea_daily.csv")
TEMPLATE_PATH = os.path.join(HERE, "dashboard_template.html")
OUTPUT_PATH = os.path.join(ROOT, "outputs", "midea_backtest_dashboard.html")
